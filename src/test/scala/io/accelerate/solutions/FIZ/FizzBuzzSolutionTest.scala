...
class FizzBuzzSolutionTest extends AnyFlatSpec with Matchers {
  "FizzBuzz" should {
    "print 'fizz' for multiples of 3" in {
  ...
  "print 'buzz' for multiples of 5" in {
 ...
 "print 'fizz buzz' for multiples of 3 and 5" in {
  ...
  "print the number for anything else" in {
    FizzBuzzSolution().fizzBuzz(0) shouldBe "0"
